...
MIDDLEWARE = [
    ...
    #
    # See: https://docs.djangoproject.com/en/5.1/ref/middleware/#middleware-ordering
    ...
    #
    # See: https://docs.djangoproject.com/en/5.1/ref/clickjacking/#how-to-use-it
...
CACHE_MIDDLEWARE_SECONDS = env("CACHE_MIDDLEWARE_SECONDS", default=0 if DEBUG else 600)
